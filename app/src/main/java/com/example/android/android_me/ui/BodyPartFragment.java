...
public class BodyPartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Load the saved state.  Otherwise, the values come from setter functions
        ...
        if(mImageIds != null){
            ...
            imageView.setOnClickListener(view -> {
                ...
                if (mImageIds != null) {
                    if (mListIndex < (mImageIds.size() - 1)) {  // We started at 0 before got here.  -1 keeps from going over
                        mListIndex++;
                    } else {
                        mListIndex = 0;
                    }
