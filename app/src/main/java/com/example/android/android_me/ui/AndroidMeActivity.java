...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    // TODO (2) Create a new class called com.example.android.android_me.ui.BodyPartFragment to display an image of an Android-Me body part
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (5) Create a new com.example.android.android_me.ui.BodyPartFragment instance and display it using the FragmentManager
        BodyPartFragment headFragment = new BodyPartFragment();

        // Use a FragmentManager and a Transaction to add the fragment to the screen.
        FragmentManager fragmentManager = getSupportFragmentManager();

        // You set up the container in the activity.xml.  So now we ADD the Fragment to it.
